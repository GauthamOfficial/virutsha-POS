    ...
    <section className="flex min-h-[calc(100vh-4.5rem)] flex-col lg:h-[calc(100vh-4.5rem)] lg:flex-row lg:overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col lg:overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-3 px-4 pb-1 pt-5 md:px-6">
          <div>
            <h1 className="text-xl font-bold tracking-wide text-ink">New Order</h1>
            <p className="mt-1 text-sm text-muted">
              Showing <span className="font-semibold text-mustard-deep">{activeLabel}</span> prices
            </p>
          </div>
      ...
      {/* Bill side */}
      <div className="w-full shrink-0 border-t border-line p-3 lg:w-[380px] lg:border-l lg:border-t-0 lg:py-4 lg:pr-4">
      ...
      {cartCount > 0 && (
        <div className="pointer-events-none fixed bottom-4 left-1/2 z-30 -translate-x-1/2 rounded-full bg-terracotta px-5 py-2 text-sm font-bold text-shell shadow-lg lg:hidden">
